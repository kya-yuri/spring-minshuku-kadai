    ...
    */
	...
	public void processSessionCompleted(Event event) {
	    ...
	    if (optionalStripeObject.isEmpty()) {
	        System.out.println("Failed to deserialize event object: " + event);
	        System.out.println("Raw JSON: " + event.getData());
	        return;
	    }

	    optionalStripeObject.ifPresent(stripeObject -> {
	        System.out.println("Stripe object successfully deserialized.");

	        // Cast and further processing
	        Session session = (Session)stripeObject;
	        SessionRetrieveParams params = SessionRetrieveParams.builder().addExpand("payment_intent").build();
	        ...
	        try {
	            ...
	            e.printStackTrace();
	            System.out.println("Failed to retrieve session with ID: " + session.getId());
	        }
	...
	public void processSessionCompleted(Event event) {
	    ...
	    if ("checkout.session.completed".equals(event.getType())) {
	        ...
	        if (stripeObject instanceof Session) {
	            ...
	            System.out.println("Failed to cast StripeObject to Session.");
	        }
	    } else {
	        System.out.println("Received unsupported event type.");
	    }
	}
